...
import SubServicePackagesManager from '../src/components/admin/SubServicePackagesManager';
      ...
      <aside className="w-20 md:w-80 glass border-l border-white/5 flex flex-col p-4 md:p-10 z-50 transition-all">
        ...
        <nav className="space-y-4 flex-grow">
          {[
            ...
            { id: 'subscriptions', label: 'الاشتراكات والكوبونات', icon: Activity, path: '/admin/subscriptions' },
                      ...
                      {industrySubServices.map(sub => (
                        <div key={sub.id} className="bg-white/5 p-8 rounded-[40px] border border-white/5 space-y-6 group">
                          ...
                          <div className="pt-6 border-t border-white/5 space-y-6">
                            ...
                            {sub.has_packages && (
                              <SubServicePackagesManager subServiceId={sub.id} />
                            )}
                          </div>
                        </div>
                      ))}
